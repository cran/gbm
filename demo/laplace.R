# LAPLACE/ABSOLUTE LOSS REGRESSION EXAMPLE

cat("Running laplace regression example.\n")
N <- 1000
X1 <- runif(N)
X2 <- 2*runif(N)
...
gbm1 <- gbm(Y~X1+X2+X3+X4+X5+X6,         # formula
            ...
            distribution="laplace",      # bernoulli, adaboost, gaussian, poisson, coxph, laplace available
